...
int main() {
    const char *input_str = "AAABBBCCCCDDDEEEEEEEE";
    ...
    if (rle_compress_cpu((const uint8_t *)input_str, input_size,
    ...
    if (rle_decompress_cpu(compressed, compressed_size,
    ...
    printf("RLE compression/decompression successful.\n");
    return 0;
}
